Directives can be defined to interact with components in various ways:
...
Function Args:
    ...
    *NOTE* Apart from el, you should treat these arguments as read-only and never modify them.
           If you need to share information across hooks, it is recommended to do so through
           element’s dataset.
